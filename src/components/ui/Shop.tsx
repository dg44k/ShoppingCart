			...
			<div className='container shop-container'>
				<div className='filters-shop'>
					<button
						...
						onClick={() => setFilterProducts(() => getFilterProducts(products, Categories.MEN_CLOTHES))}
					>
						Men's clothes
					</button>
					<button
						className='btn-filter filter-clothes'
						onClick={() => setFilterProducts(() => getFilterProducts(products, Categories.WOMEN_CLOTHES))}
					>
						Women's clothes
					</button>
					<button
						className='btn-filter filter-jewelry'
						onClick={() => setFilterProducts(() => getFilterProducts(products, Categories.JEWELRY))}
					>
						Jewelry
					</button>
					<button
						className='btn-filter filter-technics'
						onClick={() => setFilterProducts(() => getFilterProducts(products, Categories.ELECTRONICS))}
					>
						Technics
					</button>
				</div>
